...
vim.keymap.set("n", "<leader>do", "<cmd>CodeDiff<cr>", { desc = "Code Diff Open" })
vim.keymap.set("n", "<leader>dc", "<cmd>tabclose<cr>", { desc = "Code Diff Close" })
vim.keymap.set("n", "<leader>dh", "<cmd>CodeDiff history %file<cr>", { desc = "Code Diff File History" })
vim.keymap.set("n", "<leader>dH", "<cmd>CodeDiff history<cr>", { desc = "Code Diff History" })
