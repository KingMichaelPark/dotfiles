return {
    ...
    keys = {
        ...
        {
            "<leader>fp",
            function() require("fzf-lua").projects() end,
            desc = "Projects",
        },
        -- git
        {
            "<leader>gl",
            function() require("fzf-lua").git_log() end,
            desc = "Git Log",
        },
        {
            "<leader>gL",
            function() require("fzf-lua").git_log_line() end,
            desc = "Git Log Line",
        },

        {
            ...
            desc = "List [f]iles [a]active in this revision",
        },
        {
            "<leader>fn",
            function()
        ...
        {
            "<leader>fd",
            function() require("fzf-lua").diagnostics() end,
            desc = "Diagnostics",
        },
        {
            "<leader>fh",
        ...
        {
            "<leader>fm",
            function() require("fzf-lua").man_pages() end,
            desc = "Man Pages",
        },
        -- LSP
        {
        ...
        {
            "gy",
            function() require("fzf-lua").lsp_type_definitions() end,
