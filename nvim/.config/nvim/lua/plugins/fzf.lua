return {
    ...
    keys = {
        ...
        { "<leader>fr",      function() require('fzf-lua').live_grep({ hidden = true, rg_opts = "--glob !**/.git/**" }) end,      desc = "Grep Native" },
        { "<leader>fR",      function() require('fzf-lua').live_grep_glob({ hidden = true, rg_opts = "--glob !**/.git/**" }) end, desc = "Grep Glob" },
